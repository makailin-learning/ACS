...
parser.add_argument('--data', default='E:/ImageNet/', type=str, help='数据集路径')
parser.add_argument('-a', '--arch', default='ResNet') # 使用 metavar 来指定一个替代名称
...
parser.add_argument('-val_sq', '--val-freq', default=5, type=int, help='验证频次')
...
parser.add_argument('--step_epochs', default=[36,72,96], type=list,help='学习率更改epoch')
...
def main():
    ...
    val_dataset = datasets.ImageFolder(valdir, vals)
